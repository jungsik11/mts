...
docker rmi oliver173/mts-account oliver173/mts-trading oliver173/mts-admin oliver173/mts-price-generator oliver173/mts-trading-bot oliver173/mts-trade-verifier 2>/dev/null || true
