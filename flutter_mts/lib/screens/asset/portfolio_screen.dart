            ...
            children: [
              ...
              Row(
                children: [
                  ElevatedButton(
                    onPressed: () {
                      Navigator.pushNamed(context, '/transfer_history');
                    },
                    ...
                    child: const Text('내역', style: TextStyle(fontWeight: FontWeight.bold)),
                  ),
          ...
          Row(
            children: [
              Container(
                ...
                height: 44,
                decoration: BoxDecoration(
                  color: (profitNum > 0 ? settings.upColor : (profitNum < 0 ? settings.downColor : Colors.white24)).withOpacity(0.1),
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Center(
                  child: Text(
                    ticker.substring(0, 1),
                    style: TextStyle(color: profitNum > 0 ? settings.upColor : (profitNum < 0 ? settings.downColor : Colors.white70), fontWeight: FontWeight.bold, fontSize: 18),
                  ),
                ),
              ),
          ...
          Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Icon(
                    profitNum > 0 ? Icons.arrow_drop_up : (profitNum < 0 ? Icons.arrow_drop_down : Icons.remove),
                    color: profitNum > 0 ? settings.upColor : (profitNum < 0 ? settings.downColor : Colors.white70),
                    size: 16,
                  ),
                  Text(
